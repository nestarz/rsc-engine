...
var ReactSharedInternalsServer =
  React.__SERVER_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE || React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE; // HACK @bureaudouble
...
export const decodeAction = function (body, serverManifest) {
...
export const decodeFormState = function (actionResult, body, serverManifest) {
...
export const decodeReply = function (body, moduleBasePath) {
...
export const decodeReplyFromBusboy = function (busboyStream, moduleBasePath) {
...
export const registerClientReference = function (
  proxyImplementation,
  id,
  exportName
) {
...
export const registerServerReference = function (reference, id, exportName) {
...
export const renderToPipeableStream = function (model, moduleBasePath, options) {
